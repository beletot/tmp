 ...
 * @version $Id: SessionHandlerPHP.php 1788 2009-09-25 09:53:47Z andreassolberg $
 */
class SimpleSAML_SessionHandlerPHP extends SimpleSAML_SessionHandler {
	...
	protected function __construct() {
		...
		/*if(session_id() == '') {
			...
			error_log(__LINE__.' session start simplesamlphp session id = vide');
			session_start();
		}*/
		//error_log('simple saml appel session construct');
		session_id('7a9ab4005bae66376d68ff56a666000e');
		session_start();
	}
